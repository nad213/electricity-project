...
def lambda_handler(event, context):
    ...
    try:
        ...
        df_result = merge_with_existing(s3, S3_BUCKET, f"{S3_PREFIX_OUT}/production_france_detail.parquet", df_result, "date_heure")
        ...
        df_monthly = merge_with_existing(s3, S3_BUCKET, f"{S3_PREFIX_OUT}/production_mensuelle.parquet", df_monthly, "year_month")
        ...
        df_yearly = merge_with_existing(s3, S3_BUCKET, f"{S3_PREFIX_OUT}/production_annuelle.parquet", df_yearly, "year")
