...
# Google Cloud Shell : l'aperçu web expose l'app sur
# https://8000-<id>.cloudshell.dev derrière un proxy TLS. Le host exact est
# propre à chaque session → wildcard. Sans effet hors Cloud Shell ou en prod.
if DEBUG and os.getenv('CLOUD_SHELL') == 'true':
